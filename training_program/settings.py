...
ALLOWED_HOSTS = ['localhost', '192.168.157.7', '127.0.0.1']

SECRET_KEY = '2^p0phb&x&ntbsduf6afw(@efi(+!&hm_lrjr-+$5v(t0_f+6t'

LOGIN_REDIRECT_URL = 'home_url'

INDEX_PAGE = 'localhost:8080'
...
INSTALLED_APPS = [
    ...
    'training_program.apps.EdcAppointmentAppConfig',
    'training_program.apps.EdcBaseAppConfig',
    'training_program.apps.EdcDeviceAppConfig',
    'training_program.apps.EdcIdentifierAppConfig',
    'training_program.apps.EdcLabAppConfig',
    'training_program.apps.EdcMetadataAppConfig',
    'training_program.apps.EdcProtocolAppConfig',
    'training_program.apps.EdcVisitTrackingAppConfig',
    'training_program.apps.EdcFacilityAppConfig',
    'training_program.apps.AppConfig',
]
...
DASHBOARD_BASE_TEMPLATES = {
    'listboard_base_template': 'training_program/base.html',
    'dashboard_base_template': 'training_program/base.html',
