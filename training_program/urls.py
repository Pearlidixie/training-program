...
from tp_subject.admin_site import tp_subject_admin
...
#     path('admin/tp_subject/', RedirectView.as_view(url='admin/tp_subject/'),
#          name='subject_models_url'),
    path('tp_subject/', include('tp_subject.urls')),
    path('tp_screening/', include('tp_screening.urls')),
    path('subject/', include('tp_dashboard.urls')),
